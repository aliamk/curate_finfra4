...
def update_asset_class_based_on_natural_resources_strategy(funds_df, source_df, report):
    if 'Asset Class' not in funds_df.columns:
        return

    conditions = [
        (source_df['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Agriculture/Farmland', 'Natural Resources', 'Natural Capital'),
        (source_df['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Diversified Natural Resources', 'Natural Resources', 'Natural Capital'),
        (source_df['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Energy', 'Natural Resources', 'Infrastructure'),
        (source_df['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Metals and Mining', 'Natural Resources', 'Infrastructure'),
        (source_df['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Timberland', 'Natural Resources', 'Natural Capital'),
        (source_df['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Water', 'Natural Resources', 'Infrastructure')
    ]
    
    for condition, old_value, new_value in conditions:
        indices = funds_df.index[condition & (funds_df['Asset Class'] == old_value)].tolist()
        if indices:
            funds_df.loc[indices, 'Asset Class'] = new_value
            report.append(f"Asset Class updated from '{old_value}' to '{new_value}' for rows {', '.join(map(str, indices[:5])) + (' ...' if len(indices) > 5 else '')}")

    # Add the pattern and vertical gap to the report
    report.append("///////////////////////////////////////////////////////////////////////////\n")

def update_sector_primary_based_on_energy_preferences(sector_primary_df, source_df, report):
    if 'Sector - Primary' not in sector_primary_df.columns:
        return
    ...
    replacements = {
        ...
        'Non Renewables, Renewables': 'Conventional Energy; Renewable Energy',
        'Wind': 'Renewable Energy',
        'Natural Gas, Oil': 'Oil & Gas',
        'Natural Gas, Oil, Renewables': 'Oil & Gas',
        'Wind, Solar, Hydroelectric': 'Renewable Energy',
        'Midstream, Natural Gas, Oil': 'Oil & Gas',
        'Solar, Wind, BioMass, Geothermal, Hydroelectric': 'Renewable Energy',
        'Solar, BioMass, Wind': 'Renewable Energy',
        'Natural Gas': 'Oil & Gas',
        'Non Renewables': 'Conventional Energy',
        'BioMass': 'Renewable Energy',
        'Solar, BioMass, Wind, Hydroelectric': 'Renewable Energy',
        'Natural Gas, Renewables': 'Oil & Gas',
        'Hydroelectric': 'Renewable Energy',
        'Midstream, Natural Gas, Oil, Renewables': 'Oil & Gas',
        'Upstream, Natural Gas, Oil': 'Oil & Gas',
        'Wind, Hydroelectric': 'Renewable Energy',
        'Midstream, Renewables': 'Oil & Gas',
        'Midstream': 'Oil & Gas',
        'Natural Gas, Solar, BioMass, Wind, Hydroelectric': 'Renewable Energy',
        'Natural Gas, Wind, Solar': 'Renewable Energy',
        'Natural Gas, Oil, Wind, Solar': 'Renewable Energy',
        'Midstream, Natural Gas': 'Oil & Gas',
        'Oil Field Services, Upstream, Midstream, Downstream, Natural Gas, Oil, Solar, Wind, BioMass, Geothermal, Hydroelectric': 'Oil & Gas',
        'Midstream, Non Renewables, Renewables': 'Oil & Gas',
        'Solar, BioMass': 'Renewable Energy',
        'Upstream, Midstream, Natural Gas, Oil': 'Oil & Gas',
        'Wind, Solar, Geothermal': 'Renewable Energy',
        'Wind, Solar, Geothermal, Hydroelectric': 'Renewable Energy',
        'Solar, BioMass, Hydroelectric': 'Renewable Energy',
        'Upstream, Midstream, Natural Gas, Oil, Renewables': 'Oil & Gas',
        'Oil Field Services, Midstream, Natural Gas, Oil': 'Oil & Gas',
        'Natural Gas, Solar': 'Oil & Gas',
        'Midstream, Downstream, Natural Gas, Oil': 'Oil & Gas',
        'Midstream, Natural Gas, Renewables': 'Oil & Gas',
        'Coal': 'Conventional Energy',
        'Non Renewables, Wind, Solar': 'Renewable Energy',
        'Natural Gas, Wind, Solar, Hydroelectric': 'Renewable Energy',
        'Oil': 'Oil & Gas',
        'Natural Gas, Solar, BioMass, Wind': 'Renewable Energy',
        'Geothermal, Hydroelectric': 'Renewable Energy',
        'Natural Gas, BioMass': 'Oil & Gas',
        'Solar, BioMass, Wind, Geothermal': 'Renewable Energy',
        'Natural Gas, Wind': 'Oil & Gas',
        'Midstream, Coal, Natural Gas, Oil, Solar, Wind, BioMass, Geothermal, Hydroelectric': 'Oil & Gas',
        'Oil, Renewables': 'Oil & Gas',
        'Oil, Wind, Solar': 'Oil & Gas',
        'Downstream, Natural Gas, Oil': 'Oil & Gas',
        'Upstream, Wind, Solar': 'Renewable Energy',
        'Upstream, Midstream, Downstream, BioMass': 'Oil & Gas',
        'Midstream, Natural Gas, Oil, Wind, Solar, Hydroelectric': 'Oil & Gas',
        'Upstream, Midstream, Downstream, Renewables': 'Oil & Gas',
        'Midstream, Downstream, Natural Gas, Oil, Renewables': 'Oil & Gas',
        'Downstream, Renewables': 'Oil & Gas',
        'Coal, Oil, Hydroelectric': 'Oil & Gas',
        'Geothermal': 'Renewable Energy',
        'Natural Gas, Wind, Hydroelectric': 'Renewable Energy',
        'Natural Gas, Oil, Wind, Solar, Hydroelectric': 'Oil & Gas',
        'Midstream, Downstream, Natural Gas, Oil, Solar, BioMass, Wind': 'Oil & Gas',
        'Upstream, Midstream, Downstream, Natural Gas, Oil, Solar, BioMass, Wind': 'Oil & Gas',
        'Solar, Hydroelectric': 'Renewable Energy',
        'Midstream, Downstream, Solar': 'Oil & Gas',
        'Natural Gas, Oil, Hydroelectric': 'Oil & Gas',
        'Natural Gas, Solar, Wind, BioMass, Geothermal, Hydroelectric': 'Renewable Energy',
        'Midstream, Coal, Natural Gas, Oil, Solar, Hydroelectric': 'Oil & Gas',
        'Downstream, Non Renewables': 'Oil & Gas',
        'Upstream, Midstream': 'Oil & Gas',
        'Downstream, Non Renewables, Renewables': 'Conventional Energy',
        'Natural Gas, Hydroelectric': 'Conventional Energy; Renewable Energy',
        'Midstream, Natural Gas, Oil, Geothermal': 'Oil & Gas',
        'Wind, BioMass': 'Renewable Energy',
        'Midstream, Natural Gas, Oil, Hydroelectric': 'Oil & Gas',
        'Midstream, Downstream, Renewables': 'Oil & Gas',
        'BioMass, Geothermal': 'Renewable Energy',
        'Upstream, Downstream, Natural Gas': 'Oil & Gas',
        'Non Renewables, Solar, BioMass, Wind': 'Renewable Energy',
        'Upstream, Midstream, Downstream, Coal': 'Oil & Gas',
        'Natural Gas, Oil, BioMass': 'Oil & Gas',
        'Non Renewables, Wind, Solar, Hydroelectric': 'Renewable Energy',
        'Natural Gas, Oil, Wind': 'Oil & Gas',
        'Oil Field Services': 'Oil & Gas',
        'Oil Field Services, Midstream, Downstream, Natural Gas, Oil': 'Oil & Gas',
        'Midstream, Uranium, Natural Gas, Oil, Coal, Solar, Wind, BioMass, Geothermal, Hydroelectric': '',
        'Upstream, Downstream, Natural Gas, Oil': 'Oil & Gas'
    }
    
    for index, row in source_df.iterrows():
        if row['NR: PRIMARY NATURAL RESOURCES STRATEGY'] == 'Energy':
            energy_pref = row['NR: ENERGY PREFERENCES']
            if energy_pref in replacements:
                sector_primary_df.loc[index, 'Sector - Primary'] = replacements[energy_pref]
                report.append(f"Updated 'Sector - Primary' to '{replacements[energy_pref]}' for row {index + 2}")
...
def create_funds_tab(writer, source_df, report):
    ...
    # Apply additional replacements based on NR: PRIMARY NATURAL RESOURCES STRATEGY
    update_asset_class_based_on_natural_resources_strategy(funds_df, source_df, report)
...
def create_target_sectors_primary_tab(writer, source_df, report):
    ...
    # Apply additional replacements based on NR: PRIMARY NATURAL RESOURCES STRATEGY and NR: ENERGY PREFERENCES
    update_sector_primary_based_on_energy_preferences(target_sectors_primary_df, source_df, report)
